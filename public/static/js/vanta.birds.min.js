  ...
  (() => {
      ...
      constructor(e = {}) {
        ...
        l("resize", this.resize),
          ...
          this.options.gyroControls &&
            l("deviceorientation", this.windowGyroWrapper);
      }
      setOptions(e = {}) {
    ...
    const x = function (e, t, i, n) {
      ...
      var o = p,
        ...
        r = new c();
      r.position.z = 1;
      var a = { passThruTexture: { value: null } },
        l = T(
    ...
    const C = 800,
      V = (e = {}) => {
        ...
        const o = [];
        return (
          o.push(0, 2, 1), o.push(4, 7, 6), o.push(5, 6, 7), t.setIndex(o), t
        );
      };
    class R {
      constructor(e) {
        ...
        (this.position = new T.Vector3()),
          ...
          (this.alignment = function (e) {
            ...
            for (var r = 0, h = e.length; r < h; r++)
              Math.random() > 0.6 ||
                ((i = (t = e[r]).position.distanceTo(this.position)) > 0 &&
                  i <= s &&
                  (n.add(t.velocity), o++));
            if (o > 0) {
              n.divideScalar(o);
    ...
    class E extends l {
      ...
      initComputeRenderer() {
        ...
        !(function (e) {
          ...
          (this.velocityUniforms.predator = { value: new T.Vector3() }),
        ...
        const e = ((e) => {
          ...
          const h = function () {
              for (let e = 0; e < arguments.length; e++)
                o.array[l++] = arguments[e];
            },
            c = e.wingSpan || 20,
            d = e.birdSize || 1;
          for (let e = 0; e < S; e++)
            h(0, -0, -20 * d, 0, 4 * d, -20 * d, 0, 0, 30 * d),
          ...
          return t.scale(0.2, 0.2, 0.2);
        })(Object.assign({}, this.options, { effect: this }));
        this.birdUniforms = {
          color: { value: new T.Color(16720384) },
      ...
      getNewCol(e) {
        ...
        let r, a;
        if (
          ((a = -1 != t.colorMode.indexOf("Gradient") ? Math.random() : e),
      ...
      onUpdate() {
        ...
        if ((e > 1 && (e = 1), (this.last = this.now), M))
          ...
          for (var t = 0, i = e.length; t < i; t++) {
            ...
            const i = 16,
              r = 13;
            (s.geometry.attributes.position.array[i] =
              s.geometry.attributes.position.array[r] =
      ...
      onMouseMove(e, t) {
        if (((this.mouseX = e - 0.5), (this.mouseY = t - 0.5), !M)) {
          const e = this.boids;
          let t;
          for (
            var i = new T.Vector3(
